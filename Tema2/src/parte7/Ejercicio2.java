...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		// Hay que crear un booleano que sirva para salir del bucle for del mismo número
		...
		//Creamos un bucle for para cada número desde el 2 hasta el número en cuestión
		
		for (int j = 2; j <= num; j++) {
			//Indicamos que salir es false para que cuando pase por el true luego se reinicie
			salir = false;
			...
			//Si salir es false quiere decir que el número es primo y se le añade al contador
			if (salir == false) {
